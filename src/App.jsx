...
import Hero from './components/hero/Hero'  // Укажи правильный путь к файлу
import Filter from './components/filter/Filter';
import Tours from './components/Tours/Tours';

// Данные выносим за пределы компонента, чтобы они не пересоздавались при рендере
const ALL_TOURS = [
  {
    id: 1,
    type: "Многодневные",
    title: "Отдых в Чолпон-Ате",
       days: 4, // добавили число
